...
This data frame has 16 columns - in addition to the gene name column, each of the comparisons have 5 columns of results . Each of the 5 columns are described below.
